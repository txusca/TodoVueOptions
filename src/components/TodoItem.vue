    ...
    <div class="flex items-center px-4 py-3 border-b border-gray-400 last:border-b-0">
      ...
      <div class="flex items-center justify-center mr-2">
        <button @click="toggle" class="cursor-pointer"
          :class="{ color: todo.completed ? 'text-green-700' : 'text-gray-400' }"
      ...
      <!-- Input -->
      <div class="w-full">
        <input @keyup.enter="todoStore.editFetch(todo)" type="text" placeholder="Digite a sua tarefa"
          v-model="todo.title"
      ...
      <div class="ml-auto flex items-center justify-center">
        <button @click="todoStore.deleteTodoFetch(todo.id)" class="focus:outline-none cursor-pointer">
